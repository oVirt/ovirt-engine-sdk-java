...
public class RolePermits extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public RolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public RolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String expect, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
