...
public class Api {
    ...
    public Api(String url, String username, String password) throws MalformedURLException {
        this.connectionsPool = new ConnectionsPoolBuilder(url, username, password)
            .build();
    }
    ...
    public Api(String url, String username, String password, String key_file,
        ...
        this.connectionsPool = new ConnectionsPoolBuilder(url, username, password)
            ...
            .port(port).timeout(timeout).persistent_auth(persistent_auth)
            .insecure(insecure).filter(filter).debug(debug)
            .build();
    }
