...
public class Tree<T> {
    ...
    /**
     * Returns all the children of this location that match the given predicate.
     *
     * @param predicate the predicate that will be used to filter out the children
     * @return the list of children that match the predicate, or an empty list if no such children exist
     */
    public List<Tree<T>> getChildren(Predicate<Tree<T>> predicate) {
