...
public class StorageDomainTemplateDisks extends
     ...
     */
    @Override
    public StorageDomainTemplateDisk getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<StorageDomainTemplateDisk> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
        ...
        return list(url, org.ovirt.engine.sdk.entities.Disks.class,
                StorageDomainTemplateDisk.class, headers);
    }
