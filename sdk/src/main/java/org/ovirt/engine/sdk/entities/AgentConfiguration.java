...
/**
 * <p>Java class for AgentConfiguration complex type.
 *
...
@XmlType(name = "AgentConfiguration", propOrder = {
    "networkMappings",
    "brokerType",
    "address",
    "port",
...
public class AgentConfiguration {
    ...
    @XmlElement(name = "network_mappings")
    protected String networkMappings;
    @XmlElement(name = "broker_type")
    ...
    public boolean isSetNetworkMappings() {
        return (this.networkMappings!= null);
    }
