...
public class HostPermissions extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public HostPermission add(org.ovirt.engine.sdk.entities.Permission permission, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public HostPermission add(org.ovirt.engine.sdk.entities.Permission permission, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
