...
public class ClusterCpuProfiles extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public ClusterCpuProfile add(org.ovirt.engine.sdk.entities.CpuProfile cpuprofile, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public ClusterCpuProfile add(org.ovirt.engine.sdk.entities.CpuProfile cpuprofile, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
