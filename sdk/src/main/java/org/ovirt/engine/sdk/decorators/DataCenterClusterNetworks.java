...
public class DataCenterClusterNetworks extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterClusterNetwork add(org.ovirt.engine.sdk.entities.Network network, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterClusterNetwork add(org.ovirt.engine.sdk.entities.Network network, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
