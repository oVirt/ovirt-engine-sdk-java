...
public class ClusterGlusterHooks extends
     ...
     */
    @Override
    public ClusterGlusterHook getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<ClusterGlusterHook> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
        ...
        return list(url, org.ovirt.engine.sdk.entities.GlusterHooks.class,
                ClusterGlusterHook.class, headers);
    }
