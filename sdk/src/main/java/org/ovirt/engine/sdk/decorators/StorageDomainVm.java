...
/**
 * <p>StorageDomainVm providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.Vm }.
 */
@SuppressWarnings("unused")
public class StorageDomainVm extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action importVm(Action action, Boolean async, Boolean collapseSnapshots) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref() + "/import";
        ...
        if (collapseSnapshots != null) {
            urlBuilder.add("collapse_snapshots", collapseSnapshots, UrlParameterType.MATRIX);
        }
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action importVm(Action action, Boolean async, Boolean collapseSnapshots, String correlationId) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref() + "/import";
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action register(Action action) throws ClientProtocolException,
            ServerException, IOException {
