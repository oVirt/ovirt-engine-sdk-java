...
public class SchedulingPolicies extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public SchedulingPolicy add(org.ovirt.engine.sdk.entities.SchedulingPolicy schedulingpolicy, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public SchedulingPolicy add(org.ovirt.engine.sdk.entities.SchedulingPolicy schedulingpolicy, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
