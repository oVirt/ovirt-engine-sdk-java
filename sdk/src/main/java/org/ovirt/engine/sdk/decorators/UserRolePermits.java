...
public class UserRolePermits extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public UserRolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public UserRolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
