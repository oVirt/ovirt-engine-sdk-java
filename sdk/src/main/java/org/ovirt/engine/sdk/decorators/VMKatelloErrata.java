...
public class VMKatelloErrata extends
    ...
    public List<VMKatelloErratum> list() throws ClientProtocolException,
        ...
        return list(url, org.ovirt.engine.sdk.entities.KatelloErrata.class, VMKatelloErratum.class);
    }
    ...
    public VMKatelloErratum get(UUID id) throws ClientProtocolException,
        ...
        return getProxy().get(url, org.ovirt.engine.sdk.entities.KatelloErratum.class, VMKatelloErratum.class);
    }
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<VMKatelloErratum> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
