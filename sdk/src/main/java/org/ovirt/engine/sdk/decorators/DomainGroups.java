...
public class DomainGroups extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<DomainGroup> list(String query) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<DomainGroup> list(String query, Boolean caseSensitive) throws ClientProtocolException,
            ServerException, IOException {
