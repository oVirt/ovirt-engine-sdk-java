...
/**
 * <p>DataCenterClusterCpuProfiles providing relation and functional services
...
public class DataCenterClusterCpuProfiles extends
     ...
     */
    @Override
    public List<DataCenterClusterCpuProfile> list() throws ClientProtocolException,
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<DataCenterClusterCpuProfile> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
