...
/**
 * <p>RolePermits providing relation and functional services
...
public class RolePermits extends
     ...
     */
    @Override
    public RolePermit getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public RolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public RolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
