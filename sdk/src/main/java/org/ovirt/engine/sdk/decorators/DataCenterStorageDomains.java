...
public class DataCenterStorageDomains extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterStorageDomain add(org.ovirt.engine.sdk.entities.StorageDomain storagedomain, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterStorageDomain add(org.ovirt.engine.sdk.entities.StorageDomain storagedomain, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
