...
public class StorageDomain extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action refreshluns(Action action) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref() + "/refreshluns";
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action refreshluns(Action action, Boolean async) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref() + "/refreshluns";
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Action refreshluns(Action action, Boolean async, String correlationId) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref() + "/refreshluns";
