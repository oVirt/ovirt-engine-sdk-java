...
/**
 * <p>GroupTags providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.Tags }.
 */
@SuppressWarnings("unused")
public class GroupTags extends
     ...
     */
    @Override
    public GroupTag getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public GroupTag add(org.ovirt.engine.sdk.entities.Tag tag, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public GroupTag add(org.ovirt.engine.sdk.entities.Tag tag, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
