...
/**
 * <p>HostAgent providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.Agent }.
 */
@SuppressWarnings("unused")
public class HostAgent extends
        org.ovirt.engine.sdk.entities.Agent {
     ...
     */
    public HostAgent(HttpProxyBroker proxy) {
        this.proxy = proxy;
    }
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public HostAgent update() throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref();
