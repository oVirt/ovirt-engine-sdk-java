...
/**
 * <p>VmWatchdogs providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.Watchdogs }.
 */
@SuppressWarnings("unused")
public class VmWatchdogs extends
     ...
     */
    @Override
    public List<VmWatchdog> list() throws ClientProtocolException,
            ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
        return list(url, org.ovirt.engine.sdk.entities.Watchdogs.class, VmWatchdog.class);
    }
     ...
     */
    @Override
    public VmWatchdog get(UUID id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     */
    @Override
    public VmWatchdog getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public VmWatchdog add(org.ovirt.engine.sdk.entities.Watchdog watchdog, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public VmWatchdog add(org.ovirt.engine.sdk.entities.Watchdog watchdog, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<VmWatchdog> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
