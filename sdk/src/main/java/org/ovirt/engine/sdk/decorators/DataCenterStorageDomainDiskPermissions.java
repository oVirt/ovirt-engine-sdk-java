...
public class DataCenterStorageDomainDiskPermissions extends
     ...
     *    </pre>
     *
     * @return List of {@link DataCenterStorageDomainDiskPermission }
     *
     * @throws ClientProtocolException
     *             Signals that HTTP/S protocol error has occurred.
     * @throws ServerException
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<DataCenterStorageDomainDiskPermission> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
