...
public class ClusterAffinityGroupVMs extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public ClusterAffinityGroupVM add(org.ovirt.engine.sdk.entities.VM vm, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public ClusterAffinityGroupVM add(org.ovirt.engine.sdk.entities.VM vm, String expect, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
