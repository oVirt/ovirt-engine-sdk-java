...
public class StorageDomainFiles extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<StorageDomainFile> list(String query) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<StorageDomainFile> list(String query, Boolean caseSensitive) throws ClientProtocolException,
            ServerException, IOException {
