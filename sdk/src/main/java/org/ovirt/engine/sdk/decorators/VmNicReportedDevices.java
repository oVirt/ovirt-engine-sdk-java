...
public class VmNicReportedDevices extends
     ...
     */
    @Override
    public VmNicReportedDevice getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<VmNicReportedDevice> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
        ...
        return list(url, org.ovirt.engine.sdk.entities.ReportedDevices.class,
                VmNicReportedDevice.class, headers);
    }
