...
public class VmApplications extends
    ...
    public List<VmApplication> list() throws ClientProtocolException,
        ...
        return list(url, org.ovirt.engine.sdk.entities.Applications.class, VmApplication.class);
    }
    ...
    public VmApplication get(UUID id) throws ClientProtocolException,
        ...
        return getProxy().get(url, org.ovirt.engine.sdk.entities.Application.class, VmApplication.class);
    }
     ...
     */
    @Override
    public VmApplication getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<VmApplication> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
