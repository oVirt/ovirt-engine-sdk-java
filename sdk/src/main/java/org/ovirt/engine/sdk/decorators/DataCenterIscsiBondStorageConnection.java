...
/**
 * <p>DataCenterIscsiBondStorageConnection providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.StorageConnection }.
 */
@SuppressWarnings("unused")
public class DataCenterIscsiBondStorageConnection extends
     ...
     */
    public DataCenterIscsiBondStorageConnection(HttpProxyBroker proxy) {
        this.proxy = proxy;
    }
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterIscsiBondStorageConnection update() throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public DataCenterIscsiBondStorageConnection update(Boolean async) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref();
