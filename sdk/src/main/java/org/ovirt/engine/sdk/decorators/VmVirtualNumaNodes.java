...
public class VmVirtualNumaNodes extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public VmVirtualNumaNode add(org.ovirt.engine.sdk.entities.VirtualNumaNode virtualnumanode, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public VmVirtualNumaNode add(org.ovirt.engine.sdk.entities.VirtualNumaNode virtualnumanode, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
