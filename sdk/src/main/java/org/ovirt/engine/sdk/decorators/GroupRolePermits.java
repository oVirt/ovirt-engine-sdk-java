...
/**
 * <p>GroupRolePermits providing relation and functional services
...
public class GroupRolePermits extends
     ...
     */
    @Override
    public GroupRolePermit getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public GroupRolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public GroupRolePermit add(org.ovirt.engine.sdk.entities.Permit permit, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<GroupRolePermit> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
