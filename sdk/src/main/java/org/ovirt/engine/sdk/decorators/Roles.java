...
public class Roles extends
     ...
     */
    @Override
    public Role getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Role add(org.ovirt.engine.sdk.entities.Role role, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public Role add(org.ovirt.engine.sdk.entities.Role role, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
