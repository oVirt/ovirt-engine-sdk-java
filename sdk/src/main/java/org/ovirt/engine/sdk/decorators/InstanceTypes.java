...
public class InstanceTypes extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public InstanceType add(org.ovirt.engine.sdk.entities.InstanceType instancetype, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public InstanceType add(org.ovirt.engine.sdk.entities.InstanceType instancetype, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = SLASH + getName();
