...
public class HostTags extends
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public HostTag add(org.ovirt.engine.sdk.entities.Tag tag, String correlationId) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public HostTag add(org.ovirt.engine.sdk.entities.Tag tag, String correlationId, String expect) throws
            ClientProtocolException, ServerException, IOException {
        String url = this.parent.getHref() + SLASH + getName();
