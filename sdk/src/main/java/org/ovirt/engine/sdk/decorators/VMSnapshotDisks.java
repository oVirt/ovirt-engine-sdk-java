...
/**
 * <p>VMSnapshotDisks providing relation and functional services
...
public class VMSnapshotDisks extends
     ...
     */
    @Override
    public VMSnapshotDisk getById(String id) throws ClientProtocolException,
            ServerException, IOException {
     ...
     *
     *
     * @return List of {@link VMSnapshotDisk }
     *
     * @throws ClientProtocolException
     *             Signals that HTTP/S protocol error has occurred.
     * @throws ServerException
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public List<VMSnapshotDisk> list(Integer max) throws ClientProtocolException,
            ServerException, IOException {
