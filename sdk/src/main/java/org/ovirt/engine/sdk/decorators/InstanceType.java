...
/**
 * <p>InstanceType providing relation and functional services
 * <p>to {@link org.ovirt.engine.sdk.entities.InstanceType }.
 */
@SuppressWarnings("unused")
public class InstanceType extends
        org.ovirt.engine.sdk.entities.InstanceType {
     ...
     */
    public InstanceType(HttpProxyBroker proxy) {
        this.proxy = proxy;
    }
     ...
     *             Signals that an I/O exception of some sort has occurred.
     */
    public InstanceType update(Boolean async) throws ClientProtocolException,
            ServerException, IOException {
        String url = this.getHref();
