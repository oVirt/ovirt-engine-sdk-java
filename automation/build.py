...
def main():
    ...
    print("SDK version XYZA is \"%s\"." % version_xyza)
    ...
    settings_path = "sdk/settings.xml"
    ...
    tar_prefix = "ovirt-engine-sdk-java-%s" % full_version
    ...
    spec_path = "packaging/ovirt-engine-sdk-java.spec"
